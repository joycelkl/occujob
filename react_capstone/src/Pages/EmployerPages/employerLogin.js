                        ...
                        <Col lg="5">
                            <div className="container">
                                <div style={{ marginTop: "220px" }}>
                                    ...
                                    <p style={{ fontSize: "28px", lineHeight: "40px" }}>OccuJob responds to user’s needs by creating new communication channels and opportunities to help them find their next job. We help both job seekers and employers to accomplish their employment goals.</p>
                                </div>
                            </div>
                        </Col>
                    </Row>

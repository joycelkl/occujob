    ...
    <div className="container-fluid">
      <div className="row">
        <Form className="form-group" onSubmit={(e) => handleLogin(e)} style={{ width: "100%", padding:"0", marginTop:"20px" }}>
          <FormGroup>
            <Label for="exampleEmail" style={{fontSize:"25px", marginBottom:"10px"}}>Email</Label>
          ...
          <FormGroup>
            <Label for="examplePassword" style={{fontSize:"25px", marginBottom:"10px"}}>Password</Label>

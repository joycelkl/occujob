    ...
    .then(function() {
        ...
        return knex('employer').insert([
                ...
                return knex('job').insert([
                    { employer_id: 1, job_title: 'Designer', job_function: 'Media & Advertising', req_exp: 2, expect_salary: 1000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'North', job_type: 'PartTime', job_salary_type: 'perJob' },
                    { employer_id: 2, job_title: 'Freelance HR & Administrative Officer', job_function: 'Media & Advertising', req_exp: 2, expect_salary: 3000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'Tai Po', job_type: 'Freelance', job_salary_type: 'perJob' },
                    { employer_id: 3, job_title: 'Freelance Photographer', job_function: 'Photography / Video', req_exp: 2, expect_salary: 7000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'Islands', job_type: 'PartTime', job_salary_type: 'perJob' },
                    { employer_id: 1, job_title: 'Designer2', job_function: 'Media & Advertising', req_exp: 2, expect_salary: 10000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'North', job_type: 'PartTime', job_salary_type: 'perJob' },
                    ...
                    { employer_id: 1, job_title: 'Project Manager', job_function: 'Photography / Video', req_exp: 20, expect_salary: 15000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'Islands', job_type: 'PartTime', job_salary_type: 'perJob' },
                    { employer_id: 5, job_title: 'Photographer', job_function: 'Media & Advertising', req_exp: 12, expect_salary: 8000, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'North', job_type: 'PartTime', job_salary_type: 'perJob' },
                    ...
                    { employer_id: 1, job_title: 'Shop Keeper', job_function: 'Photography / Video', req_exp: 2, expect_salary: 6500, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'Islands', job_type: 'PartTime', job_salary_type: 'perJob' },
                    ...
                    { employer_id: 4, job_title: 'Developer5', job_function: 'Technology', req_exp: 15, expect_salary: 150, job_description: 'Design and create attractive flyers and leaflets for education business promotion', work_period: 'Flexible', expiry_date: '2022-09-13T02:44:47.173Z', status: true, job_location: 'Tai Po', job_type: 'PartTime', job_salary_type: 'perHour' },
